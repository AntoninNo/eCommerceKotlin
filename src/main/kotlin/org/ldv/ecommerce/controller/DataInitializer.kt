...
//
//        // === Catégories ===
//        val genreAction = Genre(nom="Action")
//        val genreComedie = Genre(nom = "Comédie")
//        val genreDrame = Genre(nom = "Drame")
//
...
//            synopsis = "Deux ans avant la Guerre civile, un ancien esclave du nom de Django s'associe avec un chasseur de primes d'origine allemande qui l'a libéré: il accepte de traquer avec lui des criminels recherchés. En échange, il l'aidera à retrouver sa femme perdue depuis longtemps et esclave elle aussi.",
//            prix=12,
//            distribution = mutableListOf(
//                Acteur(nom="Waltz", prenom = "Christoph"),
//                Acteur(nom="Tarantino", prenom =  "Quentin"),
//                Acteur(nom="Foxx", prenom =  "Jamie")
//            )
//        )
